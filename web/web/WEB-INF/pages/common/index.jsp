...
/*		$("#btnEp").click(function(){
	...
	function changePsw() {
        var isPswFormValid = $("#editPwdWindow").form("validate");
        if (!isPswFormValid) {
            $.messager.alert('警告', '表单信息错误');
        } else {
            var url = '${pageContext.request.contextPath}/index/changePsw';
            console.log(url);
        ...
        <div class="easyui-layout" fit="true">
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input id="txtNewPass" type="Password" class="easyui-validatebox txt01" data-options="required:true,validType:'length[4,6]'" /></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
                        <td><input id="txtRePass" type="Password" class="easyui-validatebox txt01" data-options="required:true,validType:['length[4,6]','equals[\'#txtNewPass\']']" /></td>
                    </tr>
                </table>
            </div>
            <div region="south" border="false" style="text-align: right; height: 30px; line-height: 30px;">
                <a id="btnEp" class="easyui-linkbutton" icon="icon-ok" href="javascript:changePsw()" >确定</a>
